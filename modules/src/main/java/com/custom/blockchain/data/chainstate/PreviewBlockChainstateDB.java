 ...
 */
@Component
public class PreviewBlockChainstateDB extends FlagAbstractLevelDB<Block> {
	...
	public PreviewBlockChainstateDB(final @Qualifier("ChainStateDB") DB chainstateDb, final ObjectMapper objectMapper) {
